    ...
    <article className="md:container md:max-w-[900px]">
      ...
      <div className="rounded bg-white p-4 md:p-8">
        ...
        <section className="my-4">
          ...
          <p>
            本サービスの利用を希望する方は、本規約に同意の上、runteq
            overflow運営（以降運営）の定める方法によって利用登録を申請し、運営がこれを承認することによって、本サービスの利用登録をすることができます。
          </p>
        </section>
        <section className="my-4">
        ...
        <section className="my-4">
          ...
          <p>
            運営は、ユーザーに対し、本サービスが提供する文章、画像、動画、ソフトウェア、プログラム、コードその他のコンテンツについて、本サービスの利用範囲内における私的な利用を許諾します。この範囲を超えて本サービスが提供するコンテンツを利用することは一切禁止します。
            <br />
        ...
        <section className="my-4">
          ...
          <p>
            運営は、運営又は本サービス独自のポイントを発行することがあります。この場合の詳細は、本サービス内その他運営所定の場所において別途定めるところによります。
          </p>
        </section>
        <section className="my-4">
        ...
        <section className="my-4">
          ...
          <p>
            本サービス内で取得した一切のコンテンツについては、手段の如何を問わず、以下の取引を一切禁止します。
          </p>
          <ul className="ml-8 mt-4 list-disc">
            <li>売買</li>
            <li>
        ...
        <section className="my-4">
          ...
          <p>
            ...
            消費者契約に該当する場合であっても、運営は、運営の過失（重過失を除きます。）によってユーザーに生じた損害のうち、ユーザーに直接かつ現実に発生した損害についてのみ賠償責任を負うものとし、また、その賠償額は金1万円を上限とします。
          </p>
        </section>
        <section className="my-4">
