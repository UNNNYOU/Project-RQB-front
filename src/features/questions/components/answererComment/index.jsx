  ...
  return (
    <div className="container mx-auto p-4">
      <div className="relative mr-20 rounded-lg bg-white p-4 shadow-md">
        <div className="absolute -right-12 top-0 flex size-14 translate-x-full items-center justify-center rounded-full bg-gray-300">
          <span className="text-xs text-gray-600">{comment.author.icon}</span>
        </div>
        <div
